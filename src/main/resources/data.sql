...
INSERT INTO locations (id, name, location_type) VALUES (1, 'Argiro', 'DINING_HALL');

INSERT INTO account_types (id, name, description, money_type, balance)
    VALUES (1, 'CLASS', 'Lectures attendance', 'Points', 1000.0);

-- User 1 has 2 accounts (CLASS and RESTAURANT)
INSERT INTO accounts (id, member_id, account_type_id, balance) VALUES (1, 1, 1, 1000.0);

-- Event 1 is a CLASS event, User 1 has registered for it, User 2 has registered for one session in it
INSERT INTO events (id, location_id, account_type_id, start_date_time, end_date_time)
    VALUES (1, 1, 1, '2024-01-01 10:00:00', '2024-02-01 12:00:00');
...
INSERT INTO scanners (id, location_id) VALUES (1, 1);