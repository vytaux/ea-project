...
public class AttendanceServiceImplTest {
    ...
    public void testGetAttendanceByAccountTypeByDateFromTo() {
        ...
        when(eventRepository.getByAccountTypeAndDateFromTo(any(AccountType.class), any(LocalDateTime.class), any(LocalDateTime.class)))
        ...
        assertEquals(AccountType.DINING_POINTS, response.getAccountType());
